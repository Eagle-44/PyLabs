...
class Example:
    ...
    def start(self):
        manager = WoodworkingMachineManager([
            ...
            CircularSaw("JM", "31-12", 1879, 1100, Companies.DniproM, 6666, 70, "Circular Disk 20cm",10),
            ThicknessPlaner("PL", "7821", 3999, 2125, Companies.Makita, 10000, 85, 2, "Cutter Head")
        ])
        ...
        manager.get_workbench(2).turn_on()
        manager.add_new_workbenches()